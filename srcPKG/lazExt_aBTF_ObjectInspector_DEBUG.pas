unit lazExt_aBTF_ObjectInspector_DEBUG;
...
var _WndDBG_:TlazExt_aBTF_ObjectInspector_wndDBG;
...
procedure TlazExt_aBTF_ObjectInspector_wndDBG.FormClose(Sender:TObject; var CloseAction:TCloseAction);
begin
    CloseAction:=caFree;
   _WndDBG_:=NIL;
end;
...
procedure TlazExt_aBTF_ObjectInspector_wndDBG.a_ClearExecute(Sender: TObject);
begin
    memo1.Clear;
end;
...
procedure TlazExt_aBTF_ObjectInspector_wndDBG.a_StayOnTopExecute(Sender: TObject);
begin
    if self.FormStyle=fsStayOnTop then self.FormStyle:=fsNormal
    else self.FormStyle:=fsStayOnTop;
end;

procedure TlazExt_aBTF_ObjectInspector_wndDBG.a_StayOnTopUpdate(Sender: TObject);
begin // ????
...
procedure TlazExt_aBTF_ObjectInspector_wndDBG.Message(const TextMSG:string);
var tmp:string;
begin
...
procedure TlazExt_aBTF_ObjectInspector_wndDBG.Message(const msgTYPE,msgTEXT:string);
begin
    if msgTYPE<>''
